...
export default function WisataForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // Konversi tipe data yang berupa angka agar sesuai dengan format JSON backend
      const payload = {
        ...formData,
      ...
      navigate('/admin/wisata'); // Kembali ke halaman list
    } catch (error) {
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex gap-6 py-2">
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="text-sm text-gray-700">Gratis Tiket untuk Anak</span>
          </label>
        </div>
